  ...
  <div class="container">
              ...
              ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a href="delete-file.php?id=<?php echo $row['id'] ?>&name=<?php echo $row['unique_name']?>"><i class="material-icons">delete_forever</i></a>
                  </td>
                </tr>
              <?php
            }
    ...
    <div id='test2' class='col s12'>
      ...
      <div class="col s8 offset-s2">
        <form class="form-event" id="formEvent" action="event.php" method="post">
          <div class="row">
            <div class="input-field col s12">
          ...
          <div class="row">
            ...
            <div class="col s6">
              <input type="text" name="hour" value="" class="timepicker">
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12">
          ...
          <div class="row">
            <div class="input-field col s12 right-align">
              <input type="submit" name="Enviar" value="Enviar" class="waves-effect waves-light btn yellow darken-1">
            </div>
          </div>
        </form>
      </div>
